/* ==========================================================================
   RESHMA & AFTAB — WEDDING INVITATION SCRIPT
   (feature script copied in from the Karina & Faizan build — generic, no
   names/colors/content baked in, so it works as-is)
   ========================================================================== */
...
(function () {
  ...
  function initPetalRain() {
    ...
    var palettes = [
      ["#fbe6d8", "#eec3ab", "#cf9a7c"],
      ["#fbeee0", "#f0d9bd", "#cdaa7d"],
      ["#f8ece3", "#e7c9b6", "#b98f6f"],
      ["#f4e2c8", "#e0bd7a", "#a3854f"],
    ];
    var w, h, dpr;
    var rafId = null;
    ...
    function makePetal(startAbove) {
      ...
      var size = isNear ? Math.random() * 6 + 10 : Math.random() * 4 + 5;
      return {
        x: Math.random() * w,
